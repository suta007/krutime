Blockly.JavaScript["KruTime.read"] = function(block) {
  ...
  Blockly.JavaScript['KruTime.start2'] = function(block) {
    var value_gatenum2 = Blockly.JavaScript.valueToCode(block, 'GateNum', Blockly.JavaScript.ORDER_ATOMIC);
  ...
  Blockly.JavaScript['KruTime.readgate'] = function(block) {
    ...
    var code = 'DEV_I2C1.KRUTIME(0, 0x0F).getGateTime('+value_gate+')';
  return [code, Blockly.JavaScript.ORDER_NONE];
  };
